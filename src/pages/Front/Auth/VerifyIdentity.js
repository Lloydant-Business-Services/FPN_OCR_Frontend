            ...
            <div style={{background:"#FFF"}}>
                <div id="preloader" style={{display:'none'}}>
                    <div id="status">
                        ...
                        {this.state.verify_identity ? <div className={isMobile ? "mobile-container-fluid" : "cust-container4"}>
                            <div className={!isMobile ? "custom-form col-sm-10" : "custom-form col-sm-10 mt-4"}>
                                ...
                                <div class="row" style={{cursor:'pointer'}}>
                                    ...
                                    <div className={!isMobile ? "col-xl-8 col-sm-8" : "col-xl-6 col-sm-8 mt-3"}>
                                       ...
                                       <span style={!isMobile ? {fontSize:'16px'} : {fontSize:'14px'}} className="manrope-text">m****b@d***********e.com</span>
                                ...
                                <div class="row" style={{cursor:'pointer'}} onClick={this.handleVerifyAccountText}>
                                    ...
                                    <div className={!isMobile ? "col-xl-8 col-sm-12" : "col-xl-6 col-sm-12 mt-3"}>
                                       ...
                                       <span style={!isMobile ? {fontSize:'13px', color:'#84818A'} : {fontSize:'10px', color:'#84818A'}} className="manrope-text">
                                    ...
                                    <hr/>
                                        ...
                                        <div className="form-inline">
                                                ...
                                                <p className="manrope-text" style={{ color: "#84818A", fontSize: "14px" }}>
                                                   <span style={{ color: "#0e408f" }}>Sign in to a different account</span>
                                                </p>
               ...
               {this.state.verify_account ? <VerifyAccount propData={this.props.propData}/> : null}
