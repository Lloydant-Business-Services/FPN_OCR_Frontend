...
class Collections extends Component {
    ...
    getAllLevels = () => {
        Endpoint.getInstitutionLevel(this.state.payLoad?.institutionTypeId)
            .then((res) => {
                // console.log(res.data)
    ...
    loadDataFromServer = () => {
        ...
        Endpoint.getInstitutionCollections(this.state.payLoad?.institutionId)
          ...
          <Radio.Button value="small">Collection Details</Radio.Button>
                                        ...
                                        <span style={{ color: "#0e408f", cursor: "pointer", fontSize: "12px" }} onClick={() => this.addCollectionSplit(x.collectionId, x.collectionName)}>
                                        ...
                                        &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
                                        <span style={{ color: "#0e408f", cursor: "pointer", fontSize: "12px" }} onClick={() => this.addCollectionApplication(x.collectionId, x.collectionName)}>
        ...
        return (
            <>
                ...
                <Fade>
                    <div className="container-fluid py-5">
                        <>
                                    ...
                                    <div className="row" style={{ marginTop: "10px" }}>
                                        <div className="col-sm-6">
                                            <div className="form-inline" style={{ marginTop: "-10px" }}>
                                                <input type="checkbox" name="fixed_amount" checked className="" style={{ marginRight: "10px" }} />
                            ...
                            <Modal visible={this.state.pageIgnite ? true : false} title={false} onCancel={this.handleCancel} onOk={false} footer={false} width={!isMobile ? 900 : null}>
                                <div className="">
                                                    ...
                                                    <>
                                                        <div className="col-md-6">
                                                            <div style={{ width: "389px", height: "76px", border: "1px solid #84818a47", padding: "15px", borderRadius: "4px", marginBottom: "20px", flex: "end", boxSizing: "border-box" }}>
                                                                ...
                                                                <input type="checkbox" style={{ float: "right" }} onClick={() => this.selectPaymentGateway(x.id)} />
                                                            </div>
                                                        </div>
                                                        <br />
                                                        <br />
                                                ...
                                                <select className="form-control" name="collection_programme" onChange={this.handleInput}>
                                                    ...
                                                    {institutionProgrammeList &&
                                                        institutionProgrammeList.map((x) => {
                                                            return <option value={x.id}>{x.programme?.name}</option>;
                                                        })}
                                                </select>
                                            </div>
                                        </div>
                ...
                <Modal visible={this.state.applyCollectionState} title={false} onOk={this.handleOk} onCancel={this.handleCancel} footer={false} width={!isMobile ? 600 : null}>
                    <div className="modal-top">
                        <p className="manrope-text drk-text" style={{ fontSize: "20px" }}>
                            Apply Collection for <span style={{ color: "#0e408f" }}>{this.state.collection_name}</span>
                        </p>
