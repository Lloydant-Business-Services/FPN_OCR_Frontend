...
import { Progress, Tooltip, Timeline } from "antd";
...
function createPie(dataElement, pieElement) {
    ...
    var offset = 0;
    var color = ["#0e408f", "#20C9AC", "#00A5FF", "#FFA043", "#EBEAED", "#FA699D", "#FFCE74"];
    for (var i = 0; i < listData.length; i++) {
                            ...
                            <Timeline>
                                ...
                                <div className="row">
                                    <div className="col-sm-12 col-xl-11">
                                        <div className="card-dash flex-fill" style={{ background: "#0e408f", color: "#FFF", height: "102px" }}>
                                ...
                                <div className="row">
                                    <div className="col-sm-12 col-xl-11">
                                        <div className="card-dash flex-fill" style={this.state.payLoad?.hasDonePersonalVerification ? { background: "#0e408f", color: "#FFF", height: "102px" } : { color: "black", height: "102px" }}>
                                ...
                                <div className="row">
                                    <div className="col-sm-12 col-xl-11">
                                        <div className="card-dash flex-fill" style={this.state.payLoad?.hasDoneInstitutionVerification ? { background: "#0e408f", color: "#FFF", height: "102px" } : { color: "black", height: "102px" }}>
                                            <div className="card-body p-3">
                                                <div className="media">
                                                    <div className="media-body">
                                                        <p className="manrope-text" style={{ fontSize: "16px" }}>
