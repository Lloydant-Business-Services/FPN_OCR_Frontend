                    ...
                    <div className="container-fluid py-5">
                        <>
                            <div className="row">
                                <div className="col-12 col-sm-12 col-xl-6 mt-2 mt-xl-0">
                                    <h1 className="manrope-text" style={!isMobile ? { fontSize: "25px", color: "#2E2C34" } : { fontSize: "24px", color: "#2E2C34" }}>
                                    ...
                                    <div className="row" style={{ marginTop: "20px" }}>
                                        <div className="col-sm-12">
                                            <div className="form-group">
                                                ...
                                                <input type="file" name="collection_name" className="form-control" placeholder="Enter collection name" onChange={this.handleInput} />
                                            </div>
                                        </div>
                        ...
                        <div>
                                    ...
                                    <div className="row" style={{ marginTop: "10px" }}>
                                        <div className="col-sm-12">
                                            <button className="btn btn-outline-primary" style={{ border: "1px dashed #0e408f", fontSize: "12px", width: "100%" }} onClick={
...
{/* 
                        ...
                        <Table
                            ...
                            className="manrope-text table-responsive mt-5"
                        />
                    </div>
                </Fade>
            </>
