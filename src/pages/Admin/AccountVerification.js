...
const AccountVerification = () => {
    ...
    const submitRequest = () => {
		...
		formData.append("InstitutionTypeId", state.inst_type);
		formData.append("AdminPersonId", state.payLoad.personId);
    ...
    return (
        ...
        width={!isMobile ? 400 : null}>
                    <div className="modal-top text-center" style={{paddingBottom:'20px'}}>
                        ...
                        <div className="row" style={{marginTop:'20px'}}>
                            <div className="col-sm-12 col-xl-12">
                            <a className="btn btn-primary manrope-text-light" style={{ fontSize: "14px", width:'170px', padding:'15px' }} onClick={() => logOutUser(false)} 
                            //href="/admin/index"
                            >
                                    Back to Dashboard &nbsp;
                                </a>
            ...
            <div className={!isMobile ? "container py-5" : "container-fluid py-5"}>
                                            ...
                                            <div className="col-sm-12 col-xl-7">
                                                <div className="row">
                                                    <div className="col-sm-12 col-xl-10">
                                                        <div className="card-dash flex-fill" style={{ border: "1px solid #0e408f", background: "rgba(27, 82, 196, 0.02)", minHeight: "90px" }}>
                                                                        ...
                                                                        <div className="row">
                                                                            ...
                                                                            <div className="col-sm-10">
                                                                                <p className="manrope-text" style={{ fontSize: "16px", marginTop: "" }}>
                                                                                    Driver’s License, Voter's Card, NIN card or National ID Card
                                                                                </p>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                    ...
                                    <div className="col-sm-12 col-xl-6">
                                        ...
                                        <div className="col-sm-12 col-xl-6">
                                            <div className="form-group">
                                                ...
                                                <select className="form-control manrope-text-light" name="inst_type" onChange={e => handleInput(e)}>
                                                <option>Select Instistution Type</option>
                                                    {state.institutionType && state.institutionType.map((x, i) => {
                                                        return(
                                                ...
                                                {/* <input className="form-control manrope-text-light" name="inst_address" type="text" placeholder="Enter institution address" /> */}
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div className="col-xl-6 col-sm-12">
                                            ...
                                            <div className="col-xl-6 col-sm-12">
                                               ...
                                               <div className="row">
                                                   ...
                                                   <div className="col-sm-10 text-left">
                                                   <p className="manrope-text">Institution Letterhead</p>
                                                    <p className="ant-upload-hint manrope-text-light">Upload institution letterhead</p>
                                                   </div>
                                               </div>
