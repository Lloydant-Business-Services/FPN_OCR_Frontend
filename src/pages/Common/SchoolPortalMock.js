                        ...
                        <div className={isMobile ? "mobile-container-fluid" : "cust-container4"}>
                            <div className={!isMobile ? "custom-form col-sm-10" : "custom-form col-sm-10 mt-4"}>
                                ...
                                <p className="manrope-text" style={{ fontSize: "14px", marginTop: "-10px" }}>
                                    Confirm that details presented are correct{" "}
                                ...
                                <div class="row">
                                    <div class="col-xl-12 col-sm-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control manrope-text drk-text" style={{ fontSize: "13px" }} defaultValue={"Oghenchavwuko Miracle Godspeed"} name="first_name" onChange={this.handleInput} id="first_name" />
                                ...
                                <div class="row mt-3">
                                    <div class="col-xl-12 col-sm-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control manrope-text drk-text" style={{ fontSize: "13px" }} name="email" onChange={this.onChangeEmail} id="email" />
